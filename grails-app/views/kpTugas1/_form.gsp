...
<div id="firstColumn" style="width:50%; float:left;" xmlns="http://www.w3.org/1999/html">
        ...
        <div class="fieldcontain ${hasErrors(bean: kpTugas1Instance, field: 'dhIpAddress', 'error')} ">
            <label for="dhIpAddress">
                ...
                <g:set var="kpTugas1Instance.dhIpAddress" value="${dhIP[0].toString()+'.'+dhIP[1].toString()+'.'+dhIP[2].toString()+'.'+dhIP[3].toString()}"/>
        </div>
            ...
            <script>
                ...
                function fungsi()
                {
                    ...
                    $.get(urlTestConnection, {ipAddress:data})
                            ...
                            .error(function(){ alert(strInvalidIpMessage); })
                            .complete(function(){})

                }
            </script>

           <input type="text" id="sgIpAddress" name="sgIpAddress" placeholder="xxx.xxx.xxx.xxx" value="${kpTugas1Instance?.sgIpAddress}" />
             <!-- <g:remoteLink action="sgIpPing" ip="document.getElementById('textbox_id').value" update="message">Test</g:remoteLink> -->
        ...
        <div class="fieldcontain ${hasErrors(bean: kpTugas1Instance, field: 'rigType', 'error')} ">
            ...
            <g:select id="rigType" name="rigType.id" from="${MtRigType.list()}" optionKey="id" value="${kpTugas1Instance?.rigType?.id}" class="many-to-one" noSelection="['null': '']"/>
        </div>
        ...
        <div class="fieldcontain ${hasErrors(bean: kpTugas1Instance, field: 'latitude', 'error')} ">
            ...
            <g:textField name="latitudeDeg" style="width:1em;" maxlength="4" value="${kpTugas1Instance?.latitudeDeg}" placeholder="0" />
            <span class="label2">deg</span>
            <g:textField name="latitudeMin" style="width:1em;" maxlength="4" value="${kpTugas1Instance?.latitudeMin}" placeholder="0" />
            <span class="label2">min</span>
            <g:textField name="latitudeSec" style="width:1em;" maxlength="6" value="${kpTugas1Instance?.latitudeSec}" placeholder="0" />
            <span class="label2">sec</span>
            <g:textField name="latitudeNs" style="width:1em;" maxlength="1" value="${kpTugas1Instance?.latitudeNs}" placeholder="N" />
        ...
        <div class="fieldcontain ${hasErrors(bean: kpTugas1Instance, field: 'longtitude', 'error')} ">
            ...
            <g:textField name="longtitudeDeg" style="width:1em;" maxlength="4" value="${kpTugas1Instance?.longtitudeDeg}" placeholder="0" />
            <span class="label2">deg</span>
            <g:textField name="longtitudeMin" style="width:1em;" maxlength="4" value="${kpTugas1Instance?.longtitudeMin}" placeholder="0" />
            <span class="label2">min</span>
            <g:textField name="longtitudeSec" style="width:1em;" maxlength="6" value="${kpTugas1Instance?.longtitudeSec}" placeholder="0" />
            <span class="label2">sec</span>
            <g:textField name="longtitudeEw" style="width:1em;" maxlength="1" value="${kpTugas1Instance?.longtitudeEw}" placeholder="E" />
    ...
    <div id="secondColumn" style="width:50%; float:left;">
        ...
        <div class="fieldcontain ${hasErrors(bean: kpTugas1Instance, field: 'wellSpudTime', 'error')} ">
            ...
            <g:datePicker name="wellSpudTime" value="${new Date()}"/>
        </div>
        ...
        <div class="fieldcontain ${hasErrors(bean: kpTugas1Instance, field: 'permanentDatum', 'error')} ">
            ...
            <g:select id="permanentDatum" name="permanentDatum.id" from="${PermanentDatum.list()}" optionKey="id" value="${kpTugas1Instance?.permanentDatum?.id}" class="many-to-one" noSelection="['null': '']"/>
        </div>
        ...
        <div class="fieldcontain ${hasErrors(bean: kpTugas1Instance, field: 'drillingMeasured', 'error')} ">
            ...
            <g:select id="drillingMeasured" name="drillingMeasured.id" from="${DrillingMeasured.list()}" optionKey="id" value="${kpTugas1Instance?.drillingMeasured?.id}" class="many-to-one" noSelection="['null': '']"/>
        </div>
